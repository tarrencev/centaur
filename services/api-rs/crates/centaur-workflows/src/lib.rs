...
const WORKFLOW_SLACK_LIVE_WORKER_CONCURRENCY_ENV: &str = "WORKFLOW_SLACK_LIVE_WORKER_CONCURRENCY";
const DEFAULT_WORKFLOW_SLACK_LIVE_WORKER_CONCURRENCY: usize = 1;
...
impl WorkflowRuntime {
    ...
    pub async fn new_with_workflow_host_sandbox(
        ...
        let slack_live_worker = slack_live_client.start_worker(WorkerOptions {
            ...
            concurrency: worker_concurrency(
                WORKFLOW_SLACK_LIVE_WORKER_CONCURRENCY_ENV,
                DEFAULT_WORKFLOW_SLACK_LIVE_WORKER_CONCURRENCY,
            ),
            on_error: Some(Arc::new(|error| {
